...
<template>
    <div id="homeappindex" v-loading="lodingtable">
...
export default {
    ...
    data() {
      return {
        ...
        formdata:{pk_id:'',name:'',pid:'',is_hidden:'0',type:'1',path:'',client_type:'1',permission:'',icon:'',rel:'',sort:'0',description:''},
        rules:{
    ...
    methods: {
        ...
        append(store, data) {
            ...
            this.formdata={pk_id:'',name:'',pid:'',is_hidden:'0',type:'1',path:'',client_type:'1',permission:'',icon:'',rel:'',sort:'0',description:''}
            if(store){
...
#homeappindex{width:100%;}
</style>
<style lang='scss'>
    #homeappindex .el-tree-node__content{padding:5px 0;}
    #homeappindex .el-tree span{font-size:15px}
    #homeappindex .el-tree .el-button span{font-size:14px}
    #homeappindex .el-select{width:100%;}
    #homeappindex .el-dialog__close{font-size:20px}
    #homeappindex .el-dialog__body{padding-top:10px;}
    #homeappindex .el-scrollbar__wrap{padding-bottom: 17px;}
</style>